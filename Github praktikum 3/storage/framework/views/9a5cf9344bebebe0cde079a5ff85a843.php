    ...
    <div class="container m-5">
        ...
        <a href="<?php echo e(url('/clone')); ?>" class="list-group-item list-group-item-action">
            ...
            <h6 class="mt-4">Tugas no 2</h6>
                ...
                <a href="<?php echo e(url('/cloningbootstrap')); ?>" class="list-group-item list-group-item-action">
                    Cloning Bootstrap
                </a>
            </div>
...
<?php /**PATH C:\Users\Daffa\daffarifqi-app\resources\views/routing.blade.php ENDPATH**/ ?>